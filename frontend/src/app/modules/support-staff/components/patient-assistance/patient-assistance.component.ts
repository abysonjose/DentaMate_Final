...
@Component({
  selector: 'app-patient-assistance',
  template: `
    <div class="patient-assistance">
      ...
      <mat-card>
        <mat-card-content>
          <div class="coming-soon">
            ...
            <h3>Coming Soon</h3>
            <p>Patient assistance management features will be available soon.</p>
          </div>
        </mat-card-content>
      </mat-card>
    </div>
  `,
  styles: [`
    .patient-assistance { padding: 16px; max-width: 1200px; margin: 0 auto; }
...
export class PatientAssistanceComponent implements OnInit {
  constructor() { }
  ngOnInit(): void { }
}